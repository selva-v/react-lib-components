...
function GoogleMap(_ref) {
  ...
  var _useJsApiLoader = api.useJsApiLoader({
  ...
  var renderMap = function renderMap() {
    ...
    return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    }, /*#__PURE__*/React__default['default'].createElement(api.GoogleMap, {
      mapContainerStyle: containerStyle,
      options: mapOptions,
      center: center,
      zoom: zoom,
      onLoad: loadHandler
    }, mapType === 'direction' ? /*#__PURE__*/React__default['default'].createElement(api.Polyline, {
      path: coordinates.map(function (place) {
        return place.coords;
      }),
      options: lineOptions
    }) : coordinates.map(function (place) {
      return /*#__PURE__*/React__default['default'].createElement(api.Marker, {
        key: place.id,
    ...
    }), infoOpen && selectedMarker && selectedMarker.info && /*#__PURE__*/React__default['default'].createElement(api.InfoWindow, {
      ...
      className: "name"
    }, selectedMarker.info.name), /*#__PURE__*/React__default['default'].createElement("div", {
      className: "content"
    }, selectedMarker.info.content)))));
  };

  if (loadError) {
    return /*#__PURE__*/React__default['default'].createElement("div", null, "Map cannot be loaded right now, sorry.");
  }
...
GoogleMap.propTypes = {
  mapType: propTypes__default['default'].string.isRequired
};
...
var ShipServiceLoop = function ShipServiceLoop(_ref) {
  ...
  })), /*#__PURE__*/React__default['default'].createElement("ul", null, stages.map(function (port) {
